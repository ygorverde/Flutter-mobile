...
class CategoryScreen extends StatelessWidget { //camisas brancas,etc

  final DocumentSnapshot snapshot;                                   //Documento passado para 
        ...
        body: FutureBuilder<QuerySnapshot>(
          ...
          GridView.builder( 
            ...
            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
             ...
             return ProductTile("grid", data);//retorna a outra classe.
             },
             ),
          ListView.builder(
            padding: EdgeInsets.all(4.0),
